...
I> ### Definition 1
I>
I> The ZFC set theory, named after mathematicians Ernst Zermelo and Abraham Fraenkel, is a type of a formal system. The C stands for choice, after the axiom of choice[^ch3n1]. ZFC is the most common **foundation of mathematics**. It is a branch of mathematical logic that works with **sets**, which are collections of objects. It consists of 9 axioms, but we will not introduce them as the are out of scope for this book.

I> ### Definition 2
I>
I> Another system of axioms relevant to this section is Peano's axioms, which is a system of axioms that describes the natural numbers. It consists of 9 axioms, but we will name only a few:
I>
...
I> 1. If P is a predicate where {$$}P(0){/$$} is true, and for every {$$}P(n){/$$} we can prove that {$$}P(n+1){/$$}, then {$$}P(n){/$$} is true for all natural numbers, namely the induction axiom.
...
One example predicate is `P(x) = x is organic`, with {$$}P(Salad) = \top{/$$}, but {$$}P(Rock) = \bot{/$$}.
...
| {$$}P \iff Q{/$$} | Prove both {$$}P \to Q{/$$} and {$$}Q \to P{/$$} |
...
| {$$}P \iff Q{/$$} | Conclude both {$$}P \to Q{/$$} and {$$}Q \to P{/$$} |
...
X> ### Exercise 11
X>
X> We've used the rules modus tollens and modus ponens without giving an actual definition (or proof) for them. Try to prove by yourself that these two rules hold, either by constructing a truth table or a three-column proof:
X>
